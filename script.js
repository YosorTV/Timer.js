...
class Stopwatch {
    constructor(state) {
        ...
        document.querySelector(".stop").addEventListener("click", this.handleClickStop);
    ...
    render() {
        ...
        const millieseconds = (difference ?
        ...
        document.querySelector(".millieseconds").textContent = millieseconds;
    }
}

const Timer = Stopwatch.ready();